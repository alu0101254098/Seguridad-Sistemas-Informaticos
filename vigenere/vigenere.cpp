...
int main() {
  //std::string texto;
  std::string pClave_ = "solo";
  std::string texto_O = "rcrtomxxqymqurauibarufmikm";
  std::string texto_E = "eojhzsqcjqppwkthzmzi";
  int opcion;
  ...
  switch (opcion) {
    ...
    case 2:
      ...
      //std::cin >> texto;
      std::cout << "Texto ORIGINAL: " << AlgoritmoVigenere(texto_O, "gump", false) << std::endl;
